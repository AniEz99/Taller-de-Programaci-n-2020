 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:8090/publicador?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PUBLICADORSERVICE_QNAME = new QName("http://webservices/", "PublicadorService");
    ...
    static {
		...
		try {
		    ...
		    prop.load(is);
		    url = new URL(prop.getProperty("central"));
		} catch (IOException ex) {
			try {
				System.out.println("No anda bien");
				url = new URL("http://localhost:8090/publicador?wsdl");
    ...
    public Publicador getPublicadorPort() {
        return super.getPort(new QName("http://webservices/", "PublicadorPort"), Publicador.class);
    }
    ...
    public Publicador getPublicadorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "PublicadorPort"), Publicador.class, features);
    }
